...
import SenderInfo from "./Receiver Components/SenderInfo";
import SenderConnectionRequest from "./Receiver Components/SenderConnectionRequest";
import SenderOverview from "./Receiver Components/SenderOverview";
import GrpParticipants from "./Receiver Components/GrpParticipants";
import ReceiverMessageDisplay from "./Receiver Components/ReceiverMessageDisplay";
...
const SosAlert = () => {
  ...
  const accept = async () => {
    if (currentSenderId) {
      ...
      try {
        ...
        console.error("Error fetching/updating user:", err);
      }
    }
  };
  ...
  return (
    <div className="w-full bg-pink-50">
      <div className="w-9/10 mx-auto py-12 flex flex-col md:flex-row gap-8 min-h-screen">
